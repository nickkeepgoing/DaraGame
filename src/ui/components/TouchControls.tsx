 ...
 *
 *   ซ้ายล่าง : ◀ ▶  ถอย / เร่ง — ขนาด+สีใกล้เคียงกัน ไม่ให้ปุ่มถอยจมหาย
 *              (เคยเล็ก 56px สีจืด จนผู้เล่นหลายคนไม่รู้ด้วยซ้ำว่ามีปุ่มถอย)
...
export function TouchControls() {
  ...
  return (
    <div className="safe-inset pointer-events-none absolute inset-0 z-10 select-none">
      {/* ซ้าย: เดิน
          เดิมปุ่มถอยเล็ก (56px) สีจืด (neutral) ต่างจากปุ่มเร่งมาก
          ผู้เล่นหลายคนเลยไม่เห็นว่ามีปุ่มถอยอยู่เลย — ปรับให้ขนาด/สีใกล้เคียงปุ่มเร่ง
          เพื่อให้เห็นชัดว่าเป็นคู่ ◀ ▶ เดียวกัน แต่เร่งยังใหญ่กว่านิดหน่อยเพราะใช้บ่อยกว่า */}
      <div className="absolute bottom-3 left-3 flex items-end gap-2.5">
        <PadButton keys={['left']} size={76} label="ถอย" glyph="◀" tone="cool" />
