...
export const BALANCE = {
  ...
  wall: {
    ...
    startSpeed: 170,        // px/s
    accelPerSec: 1.15,      // px/s เพิ่มต่อวินาที (ถึงเพดานที่ ~139 วิ) — ลดจาก 1.4 ให้กำแพงไล่ทันช้าลง เกมง่ายขึ้น
    maxSpeed: 330,
    ...
    pushBackOnCorrect: 380, // px ตอบถูก = ผลักกำแพงถอย  ← รางวัลหลักของการตอบคำถาม (เพิ่มจาก 340 ให้ตอบถูกคุ้มขึ้น)
    speedUpOnWrong: 0.10,   // ตอบผิด = เร่ง 10% (ลดจาก 15% ให้ตอบผิดโทษเบาลง)
  ...
  level: {
    ...
    stages: [
      ...
      // (ค่า spawnEveryM/pitChance ผ่อนลงจากเดิม 7.5/0.34 — ผู้เล่นบ่นว่าแต่ละด่านผ่านยากไป)
      { name: 'ด่าน 1 · รู้จักการชนกัน', spawnEveryM: 9, skyTop: 0x5b3f6e, skyBottom: 0xffb37b, pitChance: 0.26 },
      // ด่าน 2 — การมุดตัว (เดิม 5/0.46)
      { name: 'ด่าน 2 · เขตมุดตัว', spawnEveryM: 6, skyTop: 0x3a2350, skyBottom: 0xff8a5c, pitChance: 0.36 },
      // ด่าน 3 — ผลจากการชนกัน (เดิม 3.6/0.55)
      { name: 'ด่าน 3 · ผลจากการชนกัน', spawnEveryM: 4.5, skyTop: 0x1d1129, skyBottom: 0x7b3f6a, pitChance: 0.44 },
    ],
    ...
    /** ตัวขวางมาเป็นกลุ่มติดกันได้ — โอกาสและจำนวนสูงสุดต่อกลุ่ม (ผ่อนลงจากเดิม 0.12/0.3/0.45) */
    clusterChance: { stage1: 0.08, stage2: 0.2, stage3: 0.32 },
    clusterMax: 3,
    ...
    pteroStartM: 90,
    pteroChance: { stage1: 0, stage2: 0.12, stage3: 0.22 }, // ผ่อนลงจากเดิม 0.18/0.3
    /**
